        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="#ai-value-gap" className="text-muted-foreground hover:text-accent transition-colors">
                  AI Value Gap
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">123 AI Innovation Drive, San Francisco, CA 94103</span>
              </li>
